...
//	vm2.push_back(-5);
	...
	std::cout << "size : " << v_sinsert.size() << std::endl;
	std::cout << "capacity : " << v_sinsert.capacity() << std::endl;
	...
	v_minsert.insert(v_minsert.begin() + 1, 5, -42);
	std::cout << "after : " << std::endl;
	...
	vm_minsert.insert(vm_minsert.begin() + 1, 5, -42);
	std::cout << "after : " << std::endl;
